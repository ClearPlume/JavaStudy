...
import top.fallenangel.bean.EmployeeVo;
...
public interface EmployeeMapper {
     ...
     * @return 该页的员工信息
     */
    List<Map<String, Object>> getEmployeesWithPage(@Param("pageStart") int pageStart, @Param("pageSize") int pageSize);
     ...
     * @return 员工
     */
    List<Map<String, Object>> queryEmployeeWithPage(EmployeeVo employeeVo);
