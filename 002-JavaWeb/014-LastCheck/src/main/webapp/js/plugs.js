		...
		.extend( {
			...
			jq_Panel : function(e) {
				...
				var str = "<div class='jq_dvpanel'  style='z-index:2;box-shadow: 0px 0px 5px #BCD4E5;border: 1px solid #BCD4E5 !important;position:absolute;background-Color:#fff;width:"
						...
						+ e.title
						+ "</div>"
						+ "<button title='关闭' class='btnclosepanel' style='outline:0px;line-height:30px;width:80px;height:30px;text-align:center;float:right;font-size:14px;margin-top:6px;font-weight: bold;border:0;color: rgb(0, 0, 0);background-color:transparent;cursor:pointer;opacity:0.5;filter:alpha(opacity=50);-moz-opacity:0.5;'>关闭</button>"
						+ "</div>"
